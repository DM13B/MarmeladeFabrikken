...
namespace Model.QualityControl
{
    ...
    public class ProductionQualityCheck : IProductionQualityCheck
    {
        ...
        public string ExpectedResult{get { return _ExpectedResult; }set { _ExpectedResult = value; }}
        ...
        public bool ControlResult{get { return _ControlResult; }set { _ControlResult = value; }}
        ...
        public ProductionQualityCheck(string controlName, string controlDescription, string expectedResult)
        {
